  ...
  void recordException(dynamic exception, {StackTrace stackTrace}) {
    ...
    setAttributes([
      api.Attribute.fromString(
          api.AttributeKey.exceptionType, exception.runtimeType.toString()),
      api.Attribute.fromString(
          api.AttributeKey.exceptionMessage, exception.toString()),
      api.Attribute.fromString(
          api.AttributeKey.exceptionStacktrace, stackTrace.toString()),
    ]);
  }

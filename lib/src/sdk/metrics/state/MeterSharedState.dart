 ...
 */
 import "dart:async"; import "package:@opentelemetry/api.dart" show HrTime ; import "package:@opentelemetry/core.dart" show InstrumentationScope ; import "../export/MetricProducer.dart" show MetricCollectOptions ; import '../export/metric_data.dart' show ScopeMetrics ; import "../InstrumentDescriptor.dart" show createInstrumentDescriptorWithView , InstrumentDescriptor ; import "../Meter.dart" show Meter ; import "../utils.dart" show isNotNullish , Maybe ; import "AsyncMetricStorage.dart" show AsyncMetricStorage ; import "MeterProviderSharedState.dart" show MeterProviderSharedState ; import "MetricCollector.dart" show MetricCollectorHandle ; import "MetricStorageRegistry.dart" show MetricStorageRegistry ; import "MultiWritableMetricStorage.dart" show MultiMetricStorage ; import "ObservableRegistry.dart" show ObservableRegistry ; import "SyncMetricStorage.dart" show SyncMetricStorage ; import "../aggregator/types.dart" show Accumulation , Aggregator ; import "../view/AttributesProcessor.dart" show AttributesProcessor ; import 'metrics_storage.dart' show MetricStorage ;
 /**

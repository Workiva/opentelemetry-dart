...
// @param epochMillis
HrTime numberToHrtime(num epochMillis){
  final epochSeconds = epochMillis / 1000;
  // Decimals only.
  final seconds = epochSeconds.truncate();
  // Round sub-nanosecond accuracy to nanosecond.
  final nanos = int.parse((epochSeconds - seconds).toStringAsFixed(NANOSECOND_DIGITS)) * SECOND_TO_NANOSECONDS;
  return HrTime(seconds, nanos);
}
